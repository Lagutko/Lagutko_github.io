    ...
    <div class="form-container">
        <form method="POST" action="">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="email" placeholder="oleg@mail.ru" />
            </div>
            <div class="input-group">
                <span class="input-group-text" id="basic-addon3">Дата рождения</span>
                <input type="date" class="form-control" placeholder="example@mail.ru" name="date" />
            </div>
            <div id="gender-block">
            ...
            <div id="limbs-block">
                ...
                <div class="radios">
                    ...
                    <div class="limbs-radio">
                        ...
                        <label class="form-check-label" for="female">all</label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="policy">Согласен с политикой.</label>
            </div>
